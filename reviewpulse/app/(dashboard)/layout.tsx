...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col overflow-x-hidden bg-gradient-to-br from-[#eef2fb] via-[#f2f5fc] to-[#e8efff] dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 lg:h-[100dvh] lg:max-h-[100dvh] lg:flex-row lg:overflow-hidden">
      <div
      ...
      <div className="relative z-[1] flex min-h-0 min-w-0 flex-1 flex-col lg:min-h-0 lg:overflow-hidden">
