...
import { sanitizeLocationForClient } from '@/lib/location-serialize'
...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return ok({ ...sanitizeLocationForClient(location as Record<string, unknown>), viewerPlan: user.plan })
  } catch (error) {
